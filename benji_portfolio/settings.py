# python manage.py create_default_ai_data
# python manage.py create_default_tax_data
...
RECAPTCHA_PUBLIC_KEY = '6LeHnOgpAAAAADtSMWOx5piOgEYemN_AxmAtuTPp'
RECAPTCHA_PRIVATE_KEY = '6LeHnOgpAAAAADOfLi1GsKKyeyqusrDeJeSfNdIK'
